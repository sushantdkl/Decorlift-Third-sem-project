...
import { Bath, Sofa, Armchair, Bed } from "lucide-react"
      ...
      <div className="w-[78%] mx-auto grid grid-cols-3 gap-10 my-10">
        <div>
          ...
          <p className="text-lg text-gray-600 mt-4">
            People are appreciating their interior spaces more now and we will make better use of their space. We are more aware of the importance of their own homes. I see a lot of bright, lipstick pops emerging from Europe which is exciting in the sea of neutral palettes. In any design, it's important to add the unexpected surprises to the products.
          </p>
        </div>
